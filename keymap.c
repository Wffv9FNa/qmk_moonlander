...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0]=LAYOUT(
        ...
        KC_BSPC,    GUI_A  ,    ALT_S  ,    SFT_D  ,    CTL_F  ,    KC_G   ,    KC_NUBS,            KC_MEH ,    KC_H   ,    CTL_J  ,    SFT_K  ,    ALT_L  ,    GUI_SCL,    KC_QUOTE,
        KC_NO  ,    KC_Z   ,    KC_X   ,    KC_C   ,    KC_V   ,    KC_B   ,                                    KC_N   ,    KC_M   ,    KC_COMM,    KC_DOT ,    KC_SLSH,    KC_NO   ,
        MO(2)  ,    KC_NO  ,    CW_TOGG,    TD_L4TG,    MO(1)  ,                KC_CAPS,            KC_ESC ,                MO(3)  ,    KC_HYPR,    KC_LBRC,    KC_RBRC,    MO(1)   ,
